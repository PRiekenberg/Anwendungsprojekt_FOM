...
function selectCheck(that) {
    if (that.value == "question") {
        document.querySelectorAll("#questioncontentdiv","#scenarioiddiv","#phasediv").style.display = "block";
		document.querySelectorAll("#answercontentdiv","#anserstatediv","#answerpointsdiv","#usernamediv","#passworddiv").style.display = "none";
